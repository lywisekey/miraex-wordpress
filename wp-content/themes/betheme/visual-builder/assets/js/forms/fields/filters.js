...
function mfn_field_filters_render(obj, i) {
	...
	let used_fields = [
...

		{
			...
			'value': _.has(obj, 'field_select_placeholder') ? obj['field_select_placeholder'] : '',
		},
		...
		*/
...

		{
			...
			'condition': {
				id: 'filters_field_type_'+obj.hash,
				opt: "is",
				val: ['checkbox', 'radio', 'color', 'image', 'switch']
			},
			'type': 'text',
			'param': 'number',
			're_render': true,
			'title': 'Load more limit',
			'std': '10',
			'value': _.has(obj, 'load_more_limit') ? obj['load_more_limit'] : ''
		},
