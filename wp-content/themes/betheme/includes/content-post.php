...
if( ! function_exists( 'mfn_content_post' ) ){
	function mfn_content_post( $query = false, $style = false, $attr = false ){
		...
		$button_icon = mfn_opts_get('read-more-icon','icon-doc-text');
		if( '#' == $button_icon ){
			$button_icon = '';
		}
							...
							$output .= '<div class="post-head">';
								...
								if( $show_meta ){
									...
									$output .= '<div class="post-meta clearfix">';
										...
										if( isset( $list_meta['categories'] ) && ! empty(get_the_category()) ){
								...
								if( 'photo' == $style ){
									$output .= '<div class="post-footer">';
										...
										$output .= '<div class="post-links">';
											...
											$output .= '<i class="read-more-icon '. esc_attr($button_icon) .'" aria-hidden="true"></i> <a href="'. esc_url(get_permalink()) .'" class="post-more">'. $button_text .'</a>';
										$output .= '</div>';
