...
(function($) {
  ...
  $(document).ready(function() {
    ...
    */
    ...
    // FIX: elementor + single product | disable duplicated futured image lightbox

    $('.elementor-page .woocommerce-product-gallery .woocommerce-product-gallery__image a').attr('href','');

    /**
     * Helper function to ensure the alt attribute value is safely handled
     */
      ...
      if ($('body').hasClass('one-page')) {
        ...
        menu_item.on('click', function(e) {
          ...
          if($(this).closest('.column_header_burger').length ){
            //$(this).closest('.column_header_burger').find('.mfn-header-menu-toggle').trigger('click');
            $('body').trigger('click');
          }
    ...
    $(document).on("click", ".mfn-header-tmpl-menu-sidebar .mfn-header-menu .mfn-menu-li a", function (e) {
      ...
      if( $(this).closest('#mfn-header-template').length ) return; // The header has its own functionality
    ...
    $(document).on('click', '.pager_load_more', function(e) {
      ...
      var index = $('.lm_wrapper').index( el.closest('.mcb-column-inner, .elementor-element').find('.lm_wrapper') );
      ...
      $.get( href, function( data ) {
        ...
        if ($('.lm_wrapper:eq(' + index + ')').hasClass('isotope')) {
          ...
          if (typeof href === 'undefined'){
            href = $('.lm_wrapper:eq(' + index + ') .pager_load_more', data).attr('href');
          }

          $('.lm_wrapper:eq(' + index + ') ul.products').append( $content.html() );

          var $listing = $('.lm_wrapper:eq(' + index + ') ul.products.isotope');
    ...
    $('body').on('click', '.scroll > a, a.scroll, .mcb-column.scroll a', function(e) {
      ...
      if (hash && $(hash).length) {
        ...
        $('html, body').animate({
          ...
          // fix: if something loads durring scroll
    			$('html, body').animate({
    			  scrollTop: $(hash).offset().top - offset - fixStickyHeaderH()
    			}, 75);
    		});
    ...
    $('body:not(.mfn-ui) .mfn-looped-items-slider').each(function(i) {
      ...
      if( !$('body').hasClass('mfn-ui') && typeof $slider.attr('data-autoplay') !== 'undefined' && parseFloat($slider.attr('data-autoplay')) > 0 ) {
        ...
        if( $slider.attr('data-pausehover') == '1' ){
          ...
          // swiperParams['autoplay']['disableOnInteraction'] = false;
  ...
  init: function() {
    ...
    set: function() {
      $('.mfn-marquee-text-wrapper:not(.initialized)').each(function(i, el) {
        ...
        document.body.offsetHeight; // FIX: mobile safari force reflow
